...
(function(a) {
    a.extend(a.fn, {pstrength:function(b) {
        var b = a.extend({verdects:["Muito fraca","Fraca","Média","Forte","Muito forte", "Excelente"],colors:["#f00","#c06","#f60","#3c0","#004400", "#000055"],scores:[10,15,30,40,41],common:["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey"],minchar:5}, b);
